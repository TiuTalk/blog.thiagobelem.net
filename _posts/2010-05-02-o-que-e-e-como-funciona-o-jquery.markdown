...
<p>[code language="html" light="true"]<script type="text/javascript" src="js/jquery-1.4.2.min.js"></script>
...
<p>[code language="javascript"]
(function($) {</p>
<p>	// Quando o site terminar de carregar...
...
// Quando passarmos o mouse me cima das imagens
$('ul.lista-imagens li img').hover(function() {</p>
<p>	// Escurecemos todas as imagens da lista
...
<p>[code language="javascript" firstline="9"]
...
// Quando passarmos o mouse me cima das imagens
$('ul.lista-imagens li img').hover(function() {</p>
<p>	// Escurecemos todas as OUTRAS imagens da lista
...
<p>	// Escurecemos todas as OUTRAS imagens da lista
	$('ul.lista-imagens li img').not(this).fadeTo('fast', 0.3);</p>
<p>}, function() {</p>
<p>	// Todas as imagens se acendem voltando ao estado original
