...
INSERT INTO `usuarios` VALUES (NULL, 'Administrador Teste', 'admin', SHA1( 'admin' ), 'admin@demo.com.br', 2, 1, NOW( ));[/code]
...
[code language="html"]<!-- Formulário de Login -->
...
[code language="sql" light="true"]SELECT `id`, `nome`, `nivel` FROM `usuarios` WHERE (`usuario` = 'a') AND (`senha` = 'e9d71f5ee7c92d6dc9e92ffdad17b8bd49418f98') AND (`ativo` = 1) LIMIT 1[/code]
...
[code language="php" highlight="7"]<?php</p>
...
<p>Olá, <?php echo $_SESSION['UsuarioNome']; ?>!</p>[/code]
...
[code language="php" highlight="6,9"]<?php</p>
<p>// A sessão precisa ser iniciada em cada página diferente
if (!isset($_SESSION)) session_start();</p>
